...
def dask_knn_test(X,y):
    ...
    k_max = 0
    accu_max = 0
    print('start training KNN in dask')
    #循环，取k=1到k=30，查看误差效果
    for k in k_range:
...
def dask_svm_test(X,y):
    ...
    gamma_max = 0
    accu_max = 0
    print('start training SVM in dask')
    #循环，取k=1到k=30，查看误差效果
    for k in k_range:
...
def dask_bays_test(X,y):
    ...
    k_max = 0
    accu_max = 0
    print('start training naive bays in dask')
    #循环，取k=1到k=30，查看误差效果
    for k in k_range:
...
def dask_nn_test(X,y):
    ...
    k_max = 0
    accu_max = 0
    print('start training MLP in dask')
    #循环，取k=1到k=30，查看误差效果
    for k in k_range:
...
def dask_tree_test(X,y):
    ...
    k_max = 0
    accu_max = 0
    print('start training decision tree in dask')
    #循环，取k=1到k=30，查看误差效果
    for k in k_range:
...
def dask_forest_test(X,y):
    ...
    k_max = 0
    accu_max = 0
    print('start training random forest in dask')
    #循环，取k=1到k=30，查看误差效果
    for k in k_range:
...
def dask_adaboost_test(X,y):
    ...
    k_max = 0
    accu_max = 0
    print('start training Adaboost in dask')
    #循环，取k=1到k=30，查看误差效果
    for k in k_range:
